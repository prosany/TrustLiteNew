    ...
    <section className="container">
      <div className="product-market-page">
        <div className="heading">
          <h2>Wholesale Zone</h2>
          <h5>Buy at Best Price</h5>
        </div>
          ...
          <div className="product-market-item">
            <a href="/product-market-products">
              <div className="product-market-image">
                <img
                  src="https://app.trust-lite.com/storage/app/category/fTQd2aEXvXPLtQBpIWaarrIsFBbLi6wfI7Dr8EWT.jpeg"
                  alt="sddd"
                />
              </div>
              <h2>Germents & Leather Items </h2>
            </a>
