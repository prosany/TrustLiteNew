            ...
            <ul className="cat-list">
                <li className="cat-item Man-col">
                  <Link href="/view-more/categories-products">
                    <a className="cat-link">Men's Clothing <span><Angle /></span></a>
                  </Link>
                ...
                <li className="cat-item Man-col"><a href="#" className="cat-link">Women Clothing <span><Angle /></span></a>
                  <ul className="Sub-Cat">
                      <li><Link href="/view-more/categories-products"><a href="#">Shirts</a></Link></li>
                      <li><a href="#">Women Clothing</a></li>
                      <li><a href="#">Consumer Eletronics</a></li>
                      <li><a href="#">Shirts Consumer Eletronics</a></li>
                  </ul>
                </li>
                <li className="cat-item"><a href="#" className="cat-link">Computer & Office</a></li>
